...
.page-button {
  background-color: rgb(var(--v-theme-btn-page-bg)) !important;
  border: 1px solid
  ...
  &:disabled {
    color: rgba(
      var(--v-theme-btn-texted-disabled-text),
      var(--v-btn-texted-disabled-text-opacity)
    ) !important;
    background-color: rgba(
      var(--v-theme-btn-contained-disabled-bg),
      var(--v-btn-contained-disabled-bg-opacity)
    ) !important;
  }
}
.width-60 {
...
.current-page {
  background-color: rgb(var(--v-theme-btn-page-current-bg)) !important;
  color: rgb(var(--v-theme-btn-page-current-text));
  &:hover {
    background-color: rgb(var(--v-theme-hover-bg)) !important;
  }
}
.item-count-text {
